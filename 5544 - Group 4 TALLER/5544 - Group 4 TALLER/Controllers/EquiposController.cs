...
namespace _5544___Group_4_TALLER.Controllers
{
    public class EquiposController : Controller
    {
        ...
        public EquiposController(DbGrupo4 context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("EquipoID,Nombre,LogoURL,Descripcion,Presupuesto")] Equipo equipo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EquipoID,Nombre,LogoURL,Descripcion,Presupuesto")] Equipo equipo)
        {
